...
export class ExcelService {
  ...
  public exortAsNGSTest(jsonData: any[], excelFileName: string, width: any[]): void {
    ...
    ws['!merges'] = a0;
    // worksheet['!merges'] = [{ s: { c: 2, r: 0 }, e: { c: 13, r: 0 } }];
    // worksheet['!merges'] = [{ s: { c: 14, r: 0 }, e: { c: 14, r: 0 } }];
    // worksheet['!merges'] = [{ s: { c: 15, r: 0 }, e: { c: 16, r: 0 } }];
    // worksheet['!merges'] = [{ s: { c: 17, r: 0 }, e: { c: 26, r: 0 } }];
    // worksheet['!merges'] = [{ s: { c: 27, r: 0 }, e: { c: 30, r: 0 } }];
    // worksheet['!merges'] = [{ s: { c: 31, r: 0 }, e: { c: 33, r: 0 } }];
    // worksheet['!merges'] = [{ s: { c: 34, r: 0 }, e: { c: 34, r: 0 } }];
    // worksheet['!merges'] = [{ s: { c: 35, r: 0 }, e: { c: 37, r: 0 } }];
