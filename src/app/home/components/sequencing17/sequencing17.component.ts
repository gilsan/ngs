...
@Component({
  selector: 'app-sequencing17',
  templateUrl: './sequencing17.component.html',
  styleUrls: ['./sequencing17.component.scss']
})
export class Sequencing17Component implements OnInit, AfterViewInit, OnDestroy {
  ...
  openDialog(): void {
    ...
    const dialogRef = this.dialog.open(Seq17DialogComponent, dialogConfig);
