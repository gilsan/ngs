...
export class RearchStorePathService {

  startDay = '';
  endDay = '';
  patientID = '';   // 환자번호
  pathologyNumber = ''; // 검체번호
  ...
  public setPathologyNo(id: string): void {
    this.pathologyNumber = id;
    // console.log('[102][path service][검체번호저장]', this.pathologyNumber);
  }

  public getPathologyNo(): string {
    // console.log('[106][path service][검체번호알림]', this.pathologyNumber);
    return this.pathologyNumber;
  }
